...
class ServicoVeiculoTest(unittest.TestCase):
    ...
    def test_isEmPosseDaLoja_2(self):
        ...
        placa = "NNX2015"
        self.servico.daoCompra.getUltimaData.return_value = datetime.datetime(
            2022, 10, 21)
    ...
    def test_isEmPosseDaLoja_3(self):
        ...
        self.servico.daoCompra.getUltimaData.return_value = datetime.datetime(
            2022, 10, 21)
        self.servico.daoVenda.getUltimaData.return_value = datetime.datetime(
            2022, 10, 22)
        em_posse = self.servico.isEmPosseDaLoja(placa)
        self.assertFalse(em_posse)
    ...
    def test_compra_1(self):
        ...
        self.servico.daoVenda.getUltimaData.return_value = None
        data = datetime.datetime(2024, 3, 19)

        # Execução
        compra_efetuada = self.servico.compra(placa, data)

        # Avaliação
        self.assertTrue(compra_efetuada)
